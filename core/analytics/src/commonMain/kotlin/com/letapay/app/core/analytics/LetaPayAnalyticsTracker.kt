...
@Composable
fun rememberLetaPayAnalyticsTracker(): LetaPayAnalyticsTracker {
    val analyticsHelper = rememberAnalyticsHelper()
    return remember(analyticsHelper) { LetaPayAnalyticsTracker(analyticsHelper) }
}
