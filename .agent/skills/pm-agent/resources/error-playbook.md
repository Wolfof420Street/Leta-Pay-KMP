...
3. Check for existing patterns: `search_for_pattern("@app.get|@app.post")` (Ktor)
...
3. Default choices:
   - Frontend: Compose Web 14 + TypeScript + Compose theming
   - Backend: Ktor + PostgreSQL + Redis
   - Mobile: Compose Multiplatform + StateFlow
