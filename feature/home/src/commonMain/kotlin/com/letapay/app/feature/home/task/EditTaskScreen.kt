 ...
 */
package com.letapay.app.feature.home.task
...
import com.letapay.app.feature.home.model.ActionToolbar
import com.letapay.app.feature.home.model.TaskEntity
import com.letapay.app.feature.home.generated.resources.Res
import com.letapay.app.feature.home.generated.resources.feature_home_cancel
import com.letapay.app.feature.home.generated.resources.feature_home_confirm
...
import com.letapay.app.feature.home.generated.resources.feature_home_priority
import com.letapay.app.feature.home.generated.resources.feature_home_priority_high
import com.letapay.app.feature.home.generated.resources.feature_home_priority_low
import com.letapay.app.feature.home.generated.resources.feature_home_priority_medium
...
fun EditTaskScreen(
    ...
    val title = if (task.id != 0) {
        stringResource(Res.string.feature_home_edit_task_screen_name)
    } else {
        stringResource(Res.string.feature_home_create_task_screen_name)
    }
    TrackScreenView(
        screenName = title,
...
fun EditTaskScreenContent(
    ...
    Scaffold(
        topBar = {
            ActionToolbar(
                title = if (isEditing) {
                    stringResource(Res.string.feature_home_edit_task_title)
                } else {
                    stringResource(Res.string.feature_home_create_task_title)
                },
        ...
        Column(
                ...
                trailingIcon = {
                    IconButton(onClick = { showDatePickerDialog = !showDatePickerDialog }) {
                        Icon(
                            ...
                            contentDescription = stringResource(Res.string.feature_home_select_date_description),
                ...
                trailingIcon = {
                    IconButton(onClick = { showTimePickerDialog = !showTimePickerDialog }) {
                        Icon(
                            ...
                            contentDescription = stringResource(Res.string.feature_home_select_time_description),
                            tint = MaterialTheme.colorScheme.primary,
                        )
                    }
                },
            ...
            Button(onClick = onSaveTask, modifier = Modifier.fillMaxWidth()) {
                Text(
                        text = if (isEditing) {
                        stringResource(Res.string.feature_home_edit_task_button)
                    } else {
                        stringResource(Res.string.feature_home_create_task_button)
                    },
    ...
    DatePickerDialog(
        ...
        confirmButton = {
            Button(
                ...
                Text(text = stringResource(Res.string.feature_home_confirm))
            }
        },
        dismissButton = {
            Button(onClick = onDismissButtonClicked) {
                Text(text = stringResource(Res.string.feature_home_cancel))
            }
        },
        modifier = modifier,
    ) {
...
fun TimePickerDialog(
    ...
    val dismissText = stringResource(Res.string.feature_home_cancel)
    val confirmText = stringResource(Res.string.feature_home_confirm)
    AlertDialog(
...
fun TaskPriority(
    ...
    Column(
        ...
        Text(
            text = stringResource(Res.string.feature_home_priority),
        ...
        Row(
            ...
            val priorities = listOf(
                stringResource(Res.string.feature_home_priority_low),
                stringResource(Res.string.feature_home_priority_medium),
                stringResource(Res.string.feature_home_priority_high),
            )
